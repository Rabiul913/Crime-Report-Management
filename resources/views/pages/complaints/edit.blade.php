                                                ...
                                                <div class="row ps-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="title" value="{{ $complaint->co_title }}" name="co_title" id="co_title" required>
                                                                <div class="form-control-icon">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="co aginst name" value="{{ $complaint->co_against_name }}" name="co_against_name" id="co_title" required>
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-card-heading"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Against address" value="{{ $complaint->co_against_address }}" name="co_against_address" id="co_against_address" required>
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-map"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="datetime-local" class="form-control" value="{{ $complaint->co_date > 0 ? date("Y-m-d\TH:i", strtotime($complaint->co_date)) : '' }}" name="co_date" id="co_date" required>
                                                                <div class="form-control-icon">
