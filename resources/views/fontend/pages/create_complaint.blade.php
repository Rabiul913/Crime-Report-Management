...
<section style="min-height:500px">
    <div class="container">
        <div style="background-color: #ffffff;border-radius: 3px; margin: 2% 0 2% 0;">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <select class="form-control" name="district_id" id="per_district_id" required>
                                                                    ...
                                                                    <option value="{{ $district->id }}" selected aria-readonly>{{ $district->name }}</option>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left" id="section_ps">
                                                            ...
                                                            <select class="form-control" name="police_station_id" id="police_station_id">
                                                                ...
                                                                <option value="{{$policestation->id }}">{{$policestation->station_name }}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="form-control-icon">
